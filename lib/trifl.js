...
},{"./lib/action":2,"./lib/fun":3,"./lib/route":4,"./lib/view":6}],2:[function(require,module,exports){
// Generated by CoffeeScript 1.9.0
(function() {
  var action, current, doAction, handle, handlers, update, updates,
    __slice = [].slice;
...
// Generated by CoffeeScript 1.9.0
(function() {
  var I, builtin, concat, indexof, mixin, select, startswith,
    __slice = [].slice;
...
// Generated by CoffeeScript 1.9.0
(function() {
  var Router, decode, indexof, init, query, replaceplus, router, startswith, _ref,
  ...
  Router = (function() {
    ...
    Router.prototype._check = function() {
      if (this.loc.pathname === this.win.pathname && this.loc.search === this.win.search) {
        return false;
      }
      return this._run(this.win.pathname, this.win.search);
    };
...
},{"./fun":3}],5:[function(require,module,exports){
// Generated by CoffeeScript 1.9.0
(function() {
...
},{"../vnode/handle-thunk":31,"../vnode/is-thunk":32,"../vnode/is-vnode":34,"../vnode/is-vtext":35,"../vnode/is-widget":36,"../vnode/vpatch":39,"./diff-props":41,"x-is-array":19}]},{},[1]);
