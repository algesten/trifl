...
},{"./lib/action":2,"./lib/fun":3,"./lib/route":4,"./lib/view":6,"tagg":14}],2:[function(require,module,exports){
...
// Generated by CoffeeScript 1.10.0
(function() {
  var DataHook, EventHook, MUTATION_OPTS, MutationHook, NOT_ATTRIBUTES, TextAreaHook, VDOMOut, VNode, VText, ValueHook, camelize, prepareProps;
  ...
  prepareProps = function(inp, name) {
    var attrs, k, props, v;
    props = {};
  ...
  VDOMOut.ValueHook = ValueHook = (function() {
    function ValueHook(name1, value) {
      this.name = name1;
      this.value = value;
    }

    ValueHook.prototype.hook = function(node, name, prevHook) {
      node.setAttribute(this.name, this.value);
      return node[this.name] = this.value;
    };

    ValueHook.prototype.unhook = function(node, name, newHook) {};

    return ValueHook;

  })();

  VDOMOut.TextAreaHook = TextAreaHook = (function() {
    function TextAreaHook() {}

    TextAreaHook.prototype.hook = function(node, name, prevHook) {
      return setTimeout(function() {
        var cont;
        cont = node.textContent;
        if (node.value !== cont) {
          return node.value = cont;
        }
      }, 0);
    };

    TextAreaHook.prototype.unhook = function() {};
...
},{"virtual-dom/vnode/vnode":37,"virtual-dom/vnode/vtext":39}],6:[function(require,module,exports){
(function (global){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"./fun":3,"./vdomout":5,"tagg":14,"virtual-dom":18}],7:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":32,"is-object":13}],21:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":30,"../vnode/is-vnode.js":33,"../vnode/is-vtext.js":34,"../vnode/is-widget.js":35,"./apply-properties":20,"global/document":10}],22:[function(require,module,exports){
...
},{"./create-element":21,"./dom-index":22,"./patch-op":23,"global/document":10,"x-is-array":42}],25:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":9}],27:[function(require,module,exports){
'use strict';
...
},{"browser-split":8}],30:[function(require,module,exports){
...
},{"../vnode/is-vhook":32,"is-object":13}],41:[function(require,module,exports){
var isArray = require("x-is-array")
